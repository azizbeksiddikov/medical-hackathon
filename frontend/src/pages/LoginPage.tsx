...
function LoginPage() {
  ...
  useEffect(() => {
    ...
    console.log("Expected Client ID:", "907137476909-4shdo7juf91to90e6sftk4nop5u4ck52.apps.googleusercontent.com");
    if (!googleClientId) {
      console.error("VITE_GOOGLE_CLIENT_ID is not set!");
    } else if (googleClientId !== "907137476909-4shdo7juf91to90e6sftk4nop5u4ck52.apps.googleusercontent.com") {
  ...
  const handleCredentialResponse = async (response: { credential: string }) => {
    try {
      ...
      alert(errorMessage.message || "Login failed. Please check the console for details and try again.");
    }
  };
